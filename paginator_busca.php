...
//ARQUIVO PARA PAGINAR, COLOQUEI DE 10 EM 10 REGISTROS
    ...
    function getPageElements_busca($data, $page = 1, $ipp)
    { //PEGA A VARIAVEL DA PAGINA (USUARIO), NUMERO DE PAGINAS E REGISTROS POR PAGINAS
    ...
    function printPaginator_busca($data, $page, $ipp)
    {
        ...
        echo '<div class="pag">';
        echo '<div class="" id="btnpags_busca">';
    ...
    function printThemedPaginator($data, $page, $ipp, $ppData)
    {
        ...
        for ($i = 1; $i <= $lastPage; $i++) {
            if ($page == $i) {
                ...
                echo '<a class="btn btn-mini" href="' . assembleUrlLink($i, $ipp) . '" id="btnpgbusca"  >' . $i . '</a>';
            }
        }
    }
    ...
    {
        $url =  'http://127.0.0.1/' . $_SESSION['path_projeto'] . 'usuario.php?1&isbsc=1&';   //$_SERVER['PHP_SELF'].'?';
        //$url =  'http://127.0.0.1/' + 'projeto/listar.php' + 'usuario.php?1&isbsc=1&';
        $_GET['ipp'] = $ipp;
        $_GET['page'] = $page;
